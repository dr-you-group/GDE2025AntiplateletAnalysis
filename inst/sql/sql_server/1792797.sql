...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40241186,40252640)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40241186,40252640)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44789455,4337738,4264286,4006788,4139198,4283892)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4264286,4006788,4139198,4283892)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (315296,4215140,4329847)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (315296,4215140,4329847)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (192671,443530,4103703,26727,4242106)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (192671,443530,4103703,26727,4242106)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46275677,45893522)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (46275677,45893522)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19024063,21600967,43013024,43534762,1592988,715776,40228152,21601026,21600963,1325124,45892847,1123891,19113013,40252605,19033934,21600964,19035344,21600966,40241331,43534761,19018364,21600971,1310149,21600965)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19024063,21600967,43013024,43534762,1592988,715776,40228152,21601026,21600963,1325124,45892847,1123891,19113013,40252605,19033934,21600964,19035344,21600966,40241331,43534761,19018364,21600971,1310149,21600965)
  and c.invalid_reason is null
...
(
  ...
  (
    ...
    (
      --cteEndDates
      select PERSON_ID, DATEADD(day,-1 * 14,EVENT_DATE) as END_DATE -- unpad the end date by 14
      FROM
      (
				...
				(
					...
					-- add the end dates with NULL as the row number, padding the end dates by 14 to allow a grace period for overlapping ranges.
					select PERSON_ID, DATEADD(day,14,DRUG_EXPOSURE_END_DATE), 1 as EVENT_TYPE, NULL
					FROM #drugTarget D
				) RAWDATA
      ) E
