...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4159140,37312017,37312015,4153352,37312014,4310996,37395576,37395574,37395575,42535147,761790,43531605,762344,37209562,37309657,619802,37309665,609301,441874,443454,375557,372924,42535146,42535149,42535148,42539262,4045734,42535459,42535458,42535461,42535460)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4159140,4153352,4310996,441874,443454,375557,372924,4045734)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4317150,4132309,442289,321042)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4317150,4132309,321042)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9203,9201)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (9203,9201)
  and c.invalid_reason is null
...
JOIN #Codesets cs on (vo.visit_concept_id = cs.concept_id and cs.codeset_id = 33)
) C
