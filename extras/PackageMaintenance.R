...
OhdsiRTools::checkUsagePackage("GDE2025AntiplateletAnalysis")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/GDE2025AntiplateletAnalysis.pdf")
shell("R CMD Rd2pdf ./ --output=extras/GDE2025AntiplateletAnalysis.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "GDE2025AntiplateletAnalysis")
...
OhdsiRTools::createRenvLockFile(rootPackage = "GDE2025AntiplateletAnalysis",
                                mode = "description",
